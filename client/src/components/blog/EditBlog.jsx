...
const EditBlog = () => {
  ...
  useEffect(() => {
    // Initialize Quill editor after blog data is loaded
    if (editorRef.current && !quillRef.current && formData.content) {
  ...
  const fetchBlogData = async () => {
    try {
      ...
      setAlert({ type: "error", message: "Failed to load blog data" });
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.put(`/api/blog/update/${id}`, submitData, {
        headers: {
      ...
      if (response.data.success) {
        ...
        setAlert({
          type: "error",
          message: response.data.error || "Failed to update blog post",
        });
      }
    } catch (error) {
  ...
  if (loading) {
    return <div className="blg-form-loading">Loading...</div>;
  }
    ...
    <div className="blg-form-page">
      <div className="blg-form-wrapper">
        <div className="blg-form-page-header animate__animated animate__fadeIn">
          <h1>
            <i className="fas fa-edit"></i> Edit Blog Post
          </h1>
            ...
            <div className="blg-form-group animate__animated animate__fadeInUp animate__delay-2s">
              ...
              <div className="blg-form-file-upload">
                ...
                <label htmlFor="image" className="blg-form-file-label">
                  ...
                  <span className="file-text">Choose a new image</span>
                </label>
                {imagePreview && (
                ...
                {formData.currentImageUrl && !formData.image && (
                  <span className="blg-form-current-image-label">
